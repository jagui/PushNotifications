    ...
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public MainPage()
        {
            ...
            else
            {
                ...
                ChannelUri.Text = pushChannel.ChannelUri.ToString();
            }
        }
        ...
        void PushChannel_ChannelUriUpdated(object sender, NotificationChannelUriEventArgs e)
        {
            ...
            Dispatcher.BeginInvoke(() =>
            {
                ...
                ChannelUri.Text = e.ChannelUri.ToString();
        ...
        private void Email_OnTap(object sender, GestureEventArgs e)
        {
            var emailComposeTask = new EmailComposeTask { Body = ChannelUri.Text, To = EmailInput.Text , Subject = "PushToken"};
